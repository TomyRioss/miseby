...
| 2026-09-23 | miseby | TOM-205 | M | ~20min | spark+mimo | OK: mail requerido en checkout (catalogo+menu) + clientes auto desde pedidos con matching tel>mail>nombre (2 tomy+1 juanita=2 clientes) + migracion customer_email (consentida); QA-FE PASS (build 0), QA-BE PASS; rama push, merge pendiente |
